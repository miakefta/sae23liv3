...
class CineMatchWeb:
    ...
    def mood(self, humeur_id=None):
        ...
        humeur = self.service.get_humeur(int(humeur_id))
        films = self.service.find_films(humeur_id=int(humeur_id))
    ...
    def film_detail(self, film_id=None):
        ...
        film = self.service.get_film(int(film_id))
    ...
    def delete_film(self, film_id=None):
        if film_id is not None:
            self.service.remove_film(int(film_id))
    ...
    def delete_humeur(self, humeur_id=None):
        if humeur_id is not None:
            self.service.remove_humeur(int(humeur_id))
    ...
    def delete_genre(self, genre_id=None):
        if genre_id is not None:
            self.service.remove_genre(int(genre_id))
    ...
    def search(self, titre="", genre="", annee=""):
        annee_value = int(annee) if annee else None
